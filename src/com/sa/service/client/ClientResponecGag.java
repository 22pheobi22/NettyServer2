...
public class ClientResponecGag extends Packet {
	public ClientResponecGag() {
	}

	public ClientResponecGag(PacketHeadInfo packetHead) {
	...
	public PacketType getPacketType() {
		return PacketType.ClientResponecGag;
	}
